                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="<?php echo e(route('student/list')); ?>" class="btn btn-outline-gray me-2 active"><i class="feather-list"></i></a>
                                        <a href="<?php echo e(route('student/grid')); ?>" class="btn btn-outline-gray me-2"><i class="feather-grid"></i></a>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Dell\Desktop\school_sm_laravel9\resources\views/student/student.blade.php ENDPATH**/ ?>